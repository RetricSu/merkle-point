 ...
 * @returns {string}
 */
module.exports.hash_data = function(d) {
    let deferred1_0;
    let deferred1_1;
    try {
...
const CkbSmtFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
const path = require('path').join(__dirname, 'smt_wasm_bg.wasm');
